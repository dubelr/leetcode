...
* 
* Runtime range: 1ms (81.82%)
* Space range: 42-43MB (8%)
* 
* Time to submission: 25mins
* Time to correct: 
*/
...
class Solution {
    ...
    private ListNode mergeTwoListsHelper(ListNode newList, ListNode list1, ListNode list2) {
        ...
        // case: l1, l2 non-null; newList null -> set it to min of l1, l2, increment runner
        if(newList == null){
        ...
        // else: all inputs are non-null -> return newList + pull min from (l1,l2) + recur
        if(list1.val < list2.val){
